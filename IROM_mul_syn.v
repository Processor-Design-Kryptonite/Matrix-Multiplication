...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="YES" INIT_FILE="IROM_mul.mif" INSTANCE_NAME="INS3" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" RAM_BLOCK_TYPE="M9K" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block3a_0.init_file = "IROM_mul.mif",
		ram_block3a_0.init_file_layout = "port_a",
		ram_block3a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_0.mem_init0 = 256'h000000000000000000000000000000002DDBCD50AB7B5A3EC16BAA3EC8AC1F35,
	...
	defparam
		...
		ram_block3a_1.init_file = "IROM_mul.mif",
		ram_block3a_1.init_file_layout = "port_a",
		ram_block3a_1.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_1.mem_init0 = 256'h00000000000000000000000000000000336FB3CEA4D476E9AD9EE9F98BE1B4B8,
	...
	defparam
		...
		ram_block3a_2.init_file = "IROM_mul.mif",
		ram_block3a_2.init_file_layout = "port_a",
		ram_block3a_2.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_2.mem_init0 = 256'h0000000000000000000000000000000033E6531AB4CD4E67E6397167F18D33E1,
	...
	defparam
		...
		ram_block3a_3.init_file = "IROM_mul.mif",
		ram_block3a_3.init_file_layout = "port_a",
		ram_block3a_3.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_3.mem_init0 = 256'h00000000000000000000000000000000192239292E44CA22A428A122A095517E,
	...
	defparam
		...
		ram_block3a_4.init_file = "IROM_mul.mif",
		ram_block3a_4.init_file_layout = "port_a",
		ram_block3a_4.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_4.mem_init0 = 256'h0000000000000000000000000000000018001807560350000840020000020000,
	...
	defparam
		...
		ram_block3a_5.init_file = "IROM_mul.mif",
		ram_block3a_5.init_file_layout = "port_a",
		ram_block3a_5.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_5.mem_init0 = 256'h00000000000000000000000000000000240884400110218811820C880E208400,
	...
	defparam
		...
		ram_block3a_6.init_file = "IROM_mul.mif",
	...
	defparam
		...
		ram_block3a_7.init_file = "IROM_mul.mif",
	...
	assign
		...
		wren_a = 1'b0;
endmodule //IROM_mul_altsyncram1

//synthesis_resources = M9K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  IROM_mul_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	IROM_mul_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	defparam
		...
		mgl_prim2.node_name = 1229869875,
...
`endif
	...
	IROM_mul_altsyncram	IROM_mul_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
