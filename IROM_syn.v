...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="YES" INIT_FILE="IROM.mif" INSTANCE_NAME="INN2" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" RAM_BLOCK_TYPE="M9K" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
`endif
	...
	assign
		...
		wren_a = 1'b0;
endmodule //IROM_altsyncram1

//synthesis_resources = M9K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  IROM_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		mgl_prim2.node_name = 1229868594,
...
`endif
	...
	IROM_altsyncram	IROM_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
